...
export default function Navbar() {
    return (
        <div className=" px-[100px] w-[100vw] h-[80px] shadow-sm shadow-[#d3d3d3] flex justify-between text-[17px] font-normal items-center">
            ...
            <ul className="px-[20px] flex items-center">
                <li className="px-[10px] cursor-pointer"><Button text="Log in" bg="white" fontcolor="black" /></li>
